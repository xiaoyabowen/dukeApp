...
function handleSubmitClick() {
    ...
    // var dataHtml = document.querySelector(".preview-wrapper").outerHTML;
    // alert(123,dataHtml)
    var obj = {
        cirid : 1,
        pic : 2
  ...
  /*  ajaxGetWithProgress(UploadPicCircle, obj, function (data, err) {
        alert(3455,data)
    })
*/

    Ajax('get', UploadPicCircle, obj, function (data) {
