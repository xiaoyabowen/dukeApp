        ...
        methods: {
            ...
            jobDetailClick: function (cid, comName,index,tid) {
                ...
                if (tid == 1){
                    ...
                    openNewWindow("index", "../facial/w_imageclip_frame.html", {
                        cid: cid,
                        tId: tid,
                    })
                    ...
                    openNewWindow("index", "../ouou/w_imageclip_frame.html", {
                        ouId: cid,
                        tId: tid,
                    })
                    ...
                    openNewWindow("index", "../hourse/w_imageclip_frame.html", {
                        hourseId: cid,
                        tId: tid,
                    })
                }else if (tid == 4) {
                    ...
                    openNewWindow("index", "../farmProduce/w_imageclip_frame.html", {
                        cid: cid,
                        tId: tid,
                    })
                }
